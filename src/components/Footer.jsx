			...
			<div className='subscribe'>
				<div className='subscribe-content center '>
					<div className='subscribe-content__left'>
						<div className='subscribe-content__img'>
							<img
								src='img/footer/happy-face.png'
								alt='happy customer'
								className='subscribe-img'
							/>
						</div>
						<p className='subscribe-content__text'>
					...
					<div className='subscribe-content__right'>
						<h3 className='subscribe-content__title'>SUBSCRIBE</h3>
						<h4 className='subscribe-content__subtitle'>
							FOR OUR NEWLETTER AND PROMOTION
						</h4>
						<form
							id='index-form'
							action='#'
							className='subscribe-content__form'
						>
							<input
								type='email'
							...
							/>
							<button
								className='subscribe-content__btn btn-sumbit'
								type='submit'
							>
								Subscribe
							</button>
